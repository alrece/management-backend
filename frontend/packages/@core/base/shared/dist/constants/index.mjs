...
//#endregion
//#region src/constants/vben.ts
/**
* @zh_CN GITHUB 仓库地址
*/
const VBEN_GITHUB_URL = "https://github.com/yudaocode/yudao-ui-admin-vben";
/**
* @zh_CN 文档地址
*/
const VBEN_DOC_URL = "https://doc.iocoder.cn/";
/**
* @zh_CN Vben Logo
*/
...
const VBEN_ANTDV_NEXT_PREVIEW_URL = "https://antdv-next.vben.pro";
