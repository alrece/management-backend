...
const (
	MenuService_GetMenuTree_FullMethodName = "/system.MenuService/GetMenuTree"
...
func (c *menuServiceClient) GetMenuTree(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*MenuTreeResp, error) {
...
func (c *menuServiceClient) CreateMenu(ctx context.Context, in *CreateMenuReq, opts ...grpc.CallOption) (*IDResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IDResp)
...
func (c *menuServiceClient) UpdateMenu(ctx context.Context, in *UpdateMenuReq, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
func (c *menuServiceClient) DeleteMenu(ctx context.Context, in *IDReq, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type MenuServiceServer interface {
	GetMenuTree(context.Context, *Empty) (*MenuTreeResp, error)
...
func (UnimplementedMenuServiceServer) GetMenuTree(context.Context, *Empty) (*MenuTreeResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMenuTree not implemented")
}
func (UnimplementedMenuServiceServer) CreateMenu(context.Context, *CreateMenuReq) (*IDResp, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateMenu not implemented")
}
func (UnimplementedMenuServiceServer) UpdateMenu(context.Context, *UpdateMenuReq) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateMenu not implemented")
}
func (UnimplementedMenuServiceServer) DeleteMenu(context.Context, *IDReq) (*Empty, error) {
...
func _MenuService_GetMenuTree_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MenuServiceServer).GetMenuTree(ctx, req.(*Empty))
	}
...
func _MenuService_DeleteMenu_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MenuServiceServer).DeleteMenu(ctx, req.(*IDReq))
	}
	return interceptor(ctx, in, info, handler)
}
